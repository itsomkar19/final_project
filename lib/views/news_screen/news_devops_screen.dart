import 'package:credbud/state/news/providers/news_devops_pagination_controller.dart';
...
class NewsDevOpsScreen extends ConsumerStatefulWidget {
  const NewsDevOpsScreen({super.key});

  @override
  ConsumerState<NewsDevOpsScreen> createState() => _NewsScreenState();
}

class _NewsScreenState extends ConsumerState<NewsDevOpsScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels >=
        ...
        ref
            .read(newsDevOpsPaginationControllerProvider.notifier)
            .getDevOpsArticles();
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    ref.watch(newsDevOpsPaginationControllerProvider);
    final paginationState =
        ref.watch(newsDevOpsPaginationControllerProvider.notifier).state;
          ...
          builder: (context) {
                    ...
                    SizedBox(
                      ...
                      child: NeoPopButton(
                        ...
                        onTapUp: () {
                          ref
                              .refresh(
                              newsDevOpsPaginationControllerProvider
                                  .notifier)
                              .getDevOpsArticles();
                        },
                        onTapDown: () {
            ...
            return RefreshIndicator(
              onRefresh: () {
                return ref
                    .refresh(
                    newsDevOpsPaginationControllerProvider.notifier)
                    .getDevOpsArticles();
              },
              child: ListView(
